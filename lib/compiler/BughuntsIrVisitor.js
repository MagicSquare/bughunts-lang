...
BugHuntsIrVisitor.prototype.visitRepeat = function (repeat) {
    ...
    if (this.functionName == null || !this.functionsUsed[this.functionName]){
...
BugHuntsIrVisitor.prototype.visitFunctionInvocation = function(functionInvocation) {
    ...
    this.functionName = functionInvocation.name;
    var functionDeclaration = this.functions[this.functionName];
    ...
    if (this.functionsUsed[this.functionName]){
        if (!isPartOfStructure){
        ...
        this.functionsUsed[this.functionName] = true;
    }
    this.functionName = null;
};
